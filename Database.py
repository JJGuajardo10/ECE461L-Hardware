...
def createproject():
    ...
    hwSet1 = myrequest['hwSet1']
    hwSet2 = myrequest['hwSet2']
    verify = db.createProject(name, description, projectid, hwSet1, hwSet2)
    return {'errorcode': verify}
...
def getproject():
    ...
    return {'errorcode': 0, 'projectid': project['projectid'],
            'description': project['description'], 'name': project['name'], 'hwSet1': project['hwSet1'],'hwSet1': project['hwSet1']}
